...
$extraJs   = [APP_BASE . '/public/js/search.js'];
...
<div class="mt-24">
  ...
  <div class="recent-grid">
    ...
    ?>
    <a href="<?= APP_BASE ?>/analysis/<?= htmlspecialchars($r['nse_symbol']) ?>" class="recent-card">
...
document.querySelectorAll('.hero__hint').forEach(el => {
  el.addEventListener('click', () => {
    window.location.href = APP_BASE + '/analysis/' + el.dataset.symbol;
  });
});
</script>
