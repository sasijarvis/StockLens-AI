...
<div class="mt-16">
  ...
  <div class="filter-bar">
    ...
    <button
      ...
      onclick="window.location.href=APP_BASE+'/history<?= $val ? '?verdict=' . $val : '' ?>'"
  ...
  <div class="empty-state">
    ...
    <div style="margin-top:20px;"><a href="<?= APP_BASE ?>/" class="btn btn--primary">Search Stocks</a></div>
  </div>
  <?php else: ?>
    ...
    <table class="data-table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <a href="<?= APP_BASE ?>/analysis/<?= htmlspecialchars($r['nse_symbol']) ?>" class="btn btn--ghost btn--sm">View →</a>
          </td>
        </tr>
        <?php endforeach; ?>
      </tbody>
